...
namespace Music.FrontEnd.Areas.AdminMain.Controllers
{
    public class SlidersAController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "slider_id,slider_img,slider_name,slider_link,slider_datecreate,slider_active")] Slider slider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "slider_id,slider_img,slider_name,slider_link,slider_datecreate,slider_active")] Slider slider)
        {
            if (ModelState.IsValid)
            {
